...
data PState = PState {
        ...
        -- Haddock comments accumulated in reverse order. As we tokenize the input,
        -- we prepend Haddock comments to this list, as prepending is
        -- O(1) whereas appending is O(n).
        --
        -- The consumers of this field can reverse it to get Haddock comments
        -- in ascending order of their location (BufPos).
        --
